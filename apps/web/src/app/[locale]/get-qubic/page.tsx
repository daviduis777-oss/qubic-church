...
const steps = [
  ...
  },
  {
    ...
    description: 'Buy an Anna NFT on QubicBay to join the community and support independent research.',
    icon: ShieldCheck,
    ...
    details: [
      ...
      'Purchase = community membership + research access',
    ],
  },
]
        ...
        <div className="container mx-auto px-6 max-w-3xl text-center">
          ...
          >
            ...
            <p className="text-white/30 mb-10 text-sm font-mono">
              Get your QUBIC, grab an Anna NFT, and join the research community.
            </p>
