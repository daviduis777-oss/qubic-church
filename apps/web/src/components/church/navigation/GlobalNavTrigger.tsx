      ...
      >
        <div className="flex items-center justify-between h-12 md:h-14 px-4 md:px-8 max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0">
            <a
              href="/books"
              className="hidden sm:inline-block px-2.5 py-1.5 md:px-4 md:py-1.5 text-[#D4AF37]/60 text-[10px] md:text-[11px]
                         uppercase tracking-[0.15em] md:tracking-[0.2em] font-mono
                         hover:text-[#D4AF37]
                         transition-all duration-300"
            >
              Books
            ...
            <a
              href="/donate"
              className="px-2.5 py-1.5 md:px-4 md:py-1.5 border border-[#D4AF37]/30 text-[#D4AF37]/70 text-[10px] md:text-[11px]
                         uppercase tracking-[0.15em] md:tracking-[0.2em] font-mono
                         hover:bg-[#D4AF37]/10 hover:border-[#D4AF37]/60 hover:text-[#D4AF37]
                         transition-all duration-300"
            >
              Donate
            </a>
