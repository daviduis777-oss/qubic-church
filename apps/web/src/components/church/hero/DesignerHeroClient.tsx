...
const sectionContent: Record<string, { icon: string; title: string; sub: string; body: string; date: string | null; fullManifesto?: boolean }> = {
  ...
  Founders: {
    ...
    body: (() => {
      const SOLD_COUNT = 60
      // Generate the 200 founder slots — first 60 are "awake" with flip-card NFT images
      let slots = ''
      for (let i = 1; i <= 200; i++) {
