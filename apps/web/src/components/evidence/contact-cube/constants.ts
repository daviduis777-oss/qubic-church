...
export const SPECIAL_POSITIONS = {
  ...
  genesis: { row: 72, col: 72, value: -27, label: 'Genesis PUSHBYTES_72' },
}

// Anomaly column pair colors (each pair of columns sums to 127)
export const ANOMALY_COLUMN_COLORS: Record<number, string> = {
  22: '#D4AF37',  // Gold — 13 pairs
  105: '#D4AF37',
  97: '#06B6D4',  // Cyan — 14 pairs
  30: '#06B6D4',  // Cyan — 4 pairs
  41: '#8B5CF6',  // Purple — 2 pairs
  86: '#8B5CF6',
  127: '#10B981', // Emerald — 1 pair
  0: '#10B981',
}
...
Registration marks on each page aligned perfectly when viewed in 3D.`,
  annaParallel: `The Anna Matrix parallel: 68 anomaly cells (0.41%) break the 99.58%
