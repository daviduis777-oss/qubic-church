  ...
  sidebarNav: [
...

    {
      ...
      items: [
        ...
        {
          href: '/docs/03-results/27-seven-position-signature',

          title: {
            en: 'Seven-Position Signature & Period-4 Attractor',
            pt: 'Assinatura das Sete Posicoes e Atrator Periodo-4',
          },
...

    {
      ...
      items: [
        ...
        {
          href: '/docs/03-results/26-genesis-puzzle-analysis',

          title: {
            en: 'Genesis Block Cryptographic Puzzle',
            pt: 'Puzzle Criptografico do Bloco Genesis',
          },
...

    {
      ...
      items: [
        {
          href: '/docs/03-results/28-grok-path-verification',

          title: {
            en: 'Grok Path Verification',
            pt: 'Verificacao do Caminho Grok',
          },
