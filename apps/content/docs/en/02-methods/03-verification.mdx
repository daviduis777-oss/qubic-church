...
# Expected output (individual tests; combined product is NOT computed because
# the four findings share underlying data and cannot be treated as independent):
# Finding 1: VERIFIED (p = 0.00033)
# Finding 2: VERIFIED (p < 0.0001)
# Finding 3: VERIFIED (p = 0.004)
# Finding 4: VERIFIED (p < 0.00001)
# Joint claim: all four individually survive Bonferroni correction at alpha = 0.01/4 = 0.0025.
```
