...
**Legend**: [VERIFIED] = arithmetically reproducible (checksum, cryptographic derivation, blockchain lookup); [SIGNIFICANT] = statistical test with reported p-value; [OBSERVATION] = pattern noted but test not pre-registered; [OPEN] = not yet resolved.

| # | Finding | Confidence | Status |
|---|---------|------------|--------|
| 1 | Mirror palindromes preserve address prefixes by retaining the first 10 Hash160 bytes | Reproducible | **[VERIFIED]** |
| 2 | All 24 mirror-generated addresses are valid (checksum-verified) | Reproducible | **[VERIFIED]** |
| 3 | No mirror address exhibits any blockchain activity | Reproducible (as of query date) | **[VERIFIED]** |
| 4 | XOR of Genesis and 1CFB Hash160 yields byte sum 2,671 (mod 121 = 9, mod 19 = 11) | joint p = 0.00043 | **[SIGNIFICANT]** |
| 5 | K12(K12()) is the correct Qubic seed-to-key derivation | Reproducible against reference | **[VERIFIED]** |
| 6 | The 0x7b family of 8 addresses shares identical first-byte and byte-sum constraints | Reproducible | **[VERIFIED]** |
| 7 | Byte sum 2,299 = 121 x 19 encodes NXT and Qubic constants | Arithmetic identity; interpretation speculative | **[OBSERVATION]** |
| 8 | 1CF-prefix addresses appear at 46x the expected random frequency among generated keys | Enrichment estimate; p &lt; 10⁻⁶ pending pre-registered replication | **[SIGNIFICANT]** |
| 9 | Private key derivation from Hash160 or public-key data is cryptographically infeasible | Standard ECDSA property | **[VERIFIED]** |
| 10 | The exact seed and transformation for the target 1CFB address remains undetermined | &mdash; | **[OPEN]** |
