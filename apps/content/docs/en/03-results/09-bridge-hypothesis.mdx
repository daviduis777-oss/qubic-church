...
- Z-Score: 137.06
- Statistical significance: chi-square test rejects the uniform-random null at p &lt; 0.001. (A prior iteration of this chapter cited `p < 10^-500`; that figure was not independently reproducible and has been retracted — see Statistical Assessment section below. The 137σ deviation is the reproducible quantity and is already overwhelming on its own.)
...
**Anna Matrix point symmetry (137σ deviation from random, chi-square p &lt; 0.001)**
