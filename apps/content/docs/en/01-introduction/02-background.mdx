...
description: Tracing the development of ternary computing concepts from Ultima Online (2001) through Bitcoin (2009) to Qubic (2022).
---
...
**Working Hypothesis (Tier 3, speculative)**: One possible scenario that would explain the structural overlap is that CFB encountered CCRU writings in the early 2000s and subsequently implemented related ternary AGI principles. This is a hypothesis about personal intellectual history and remains unverified — CFB has not confirmed or denied such an influence. Alternative explanations (independent convergent design, shared deeper source, coincidence given the small set of viable ternary paradigms) remain open.
</Callout>
...
## Era III: Aigarth and Qubic (2018-present)
...
| 2022 | Qubic | Helix Gate operations |
...
| Apr 2022 | Qubic mainnet | Full system deployment |
